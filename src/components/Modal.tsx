...
const Modal = ({ onClick, children }: ModalProps) => {
  ...
  return (
    ...
    >
      <div onClick={stopPropagation} className="bg-[#f8f9fa] rounded max-w-md w-full flex justify-between p-4">
        {children}
        <button onClick={onClick} className="bg-[#339af0] rounded-full p-1 self-start">
